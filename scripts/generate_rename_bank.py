...
FEATURE_RULES: list[tuple[str, str]] = [
    ...
    (r"honeycomb.*idiopathic pulmonary fibrosis|honeycomb.*\bipf\b|honeycomb.*usual interstitial|\buip\b|usual interstitial pneumonia", "Usual Interstitial Pneumonia, the pathologic pattern underlying IPF: temporally and spatially heterogeneous fibrosis (old scars, recent injury, and normal lung side by side) with subpleural, lower-lobe-predominant honeycomb cystic change"),
    ...
    (r"bleomycin|amiodarone", "pulmonary fibrosis from a known cause (cytotoxic chemotherapy or antiarrhythmic drug toxicity), rather than the idiopathic, unknown-cause fibrosis that defines IPF"),
    (r"pleural cobbleston", "a cobblestone-appearing pleural surface, the gross correlate of underlying honeycomb parenchymal remodeling"),
    (r"pulmonary fibrosis|\bipf\b", "Idiopathic Pulmonary Fibrosis: a clinical diagnosis of insidious, progressive fibrosing lung disease of unknown cause with a poor prognosis (~20% 5-year survival), typically in older smokers with dry cough and reduced DLco"),
    ...
    (r"congestion phase of pneumonia|acute inflammation in lobar pneumonia", "the earliest congestion phase: engorged alveolar capillaries with proteinaceous intra-alveolar edema and relatively few neutrophils, before dense consolidation develops"),
    ...
    (r"pleural plaque", "sharply marginated, often bilateral calcified pleural-based plaques that serve as a marker of asbestos exposure without necessarily indicating interstitial disease"),
    (r"asbestosis", "subpleural and lower-lung-zone predominant interstitial fibrosis with asbestos (ferruginous) bodies on histology, reflecting parenchymal rather than purely pleural involvement"),
    (r"silico|silicosis", "a rounded whorled hyalinized collagen nodule or upper-lung silicotic scarring"),
    (r"honeycomb", "basal subpleural reticulation with traction change and stacked cystic honeycombing"),
    ...
    (r"schaumann", "laminated, concentrically calcified conchoidal (Schaumann) bodies within a granuloma, distinct from the stellate asteroid body"),
    (r"erythema nodosum", "tender erythematous subcutaneous nodules, the extrapulmonary skin manifestation of sarcoidosis rather than a lung parenchymal finding"),
    (r"spleen sarcoid", "non-necrotizing granulomas within splenic parenchyma, reflecting extrapulmonary sarcoid organ involvement beyond the lung"),
    (r"lymph node sarcoid", "non-necrotizing granulomatous replacement of nodal architecture on lymph node biopsy"),
    (r"hilar and mediastinal adenopathy sarcoid|sarcoidosis extensive hilar", "bilateral, symmetric hilar and mediastinal lymph node enlargement, the classic presenting radiographic pattern of sarcoidosis"),
    (r"lymphangitic granuloma", "granulomas distributed along the lymphatic routes -- bronchovascular bundles, interlobular septa, and subpleural regions -- rather than randomly through the parenchyma"),
    (r"trichrome.*sarcoid", "collagen and fibrous tissue selectively stained by trichrome, highlighting hyalinized fibrosis within or around chronic granulomas"),
    (r"sarcoid.*lymphocytic bronchoalveolar|bronchoalveolar lavage.*sarcoid", "a lavage sample dominated by lymphocytes and a multinucleated giant cell rather than neutrophils"),
    (r"sarcoid|asteroid body", "non-necrotizing granulomas, sometimes with a laminated Schaumann body or stellate asteroid inclusion"),
    ...
    (r"contraction atelectasis.*tb|tb.*contraction atelectasis", "fibrotic volume loss with architectural distortion and traction on adjacent structures from healed tuberculous scarring, rather than active cavitary destruction"),
    ...
    (r"red hepatization", "the red hepatization phase: dense, liver-like consolidation from neutrophils and red blood cells filling the alveoli along with protein exudate"),
    (r"gr[ae]y hepatization", "the gray hepatization phase: red blood cells within the alveoli have lysed and lost their heme pigment, with increasing fibrin deposition marking progression toward organizing pneumonia"),
    ...
    (r"extralobar.*sequestration", "a sequestered lobe with its own separate pleural investment, systemic venous drainage, typically lower lobe/left-sided, presenting in infancy"),
    (r"intralobar.*sequestration", "a sequestered lobe sharing the visceral pleura of the adjacent normal lung, with pulmonary venous drainage, typically presenting later in childhood or adolescence"),
    (r"cpam type 3", "Stocker type 3 CPAM: a bronchiolar/alveolar-duct-type lesion, radiographically resembling pneumonia in an infant"),
    (r"type 4 cpam|type 4.*pleuropulmonary blastoma|pleuropulmonary blastoma", "Stocker type 4 CPAM: large cysts lined by alveolar type I/II cells, raising concern for overlap with pleuropulmonary blastoma if the septal stroma is even focally hypercellular"),
    (r"cpam.*pulmonary sequestration|pulmonary sequestration.*cpam", "a hybrid lesion: a multicystic CPAM-type malformation together with sequestered, systemically supplied lung tissue, presenting with atelectasis and bronchiectasis on imaging"),
    (r"large cpam.*hyperinflation|cpam.*hyperinflation", "a single very large CPAM causing mass effect with severe ipsilateral hyperinflation and multiple septae, rather than a smaller lesion or a hybrid/co-occurring-disease pattern"),
    (r"cpam.*emphysema|emphysema.*cpam", "a CPAM with coexisting emphysematous change, without a specified Stocker subtype or hybrid sequestration component"),
    ...
    (r"ards.*hyaline membrane|hyaline membrane.*ards|ards intraalveolar hyaline", "exudative-phase diffuse alveolar damage arising 3-7 days after an acute insult (infection, sepsis, shock, or trauma), with eosinophilic hyaline membranes lining damaged alveoli in ARDS"),
    (r"hyaline membrane|neonatal respiratory", "hyaline membrane changes presenting as a distinct neonatal clinical entity rather than the adult-onset, insult-triggered pattern seen in ARDS"),
    (r"ards|diffuse alveolar damage", "bilateral diffuse air-space opacity with hyaline membranes and acute alveolar injury"),
    (r"kerley|interstitial.*cardiogenic|interstitial.*congestive heart failure", "the earlier interstitial-edema stage of CHF: cardiomegaly with vascular congestion and Kerley B (septal) lines, without the confluent central alveolar filling of frank pulmonary edema"),
    (r"cardiogenic|congestive heart failure", "cardiomegaly with vascular congestion and confluent central alveolar edema, the more advanced alveolar-filling stage of cardiogenic pulmonary edema"),
    (r"goodpasture", "diffuse alveolar hemorrhage with fresh blood and hemosiderin-laden macrophages, distinguished from other vasculitic causes by linear anti-glomerular-basement-membrane immunofluorescence staining (anti-type IV collagen antibodies) and necrotizing glomerulonephritis"),
    (r"alveolar hemorrhage", "diffuse alveolar blood and hemosiderin-laden macrophage injury rather than purulent exudate, without a specified etiology-defining immunofluorescence pattern"),
    (r"pulmonary edema", "pink proteinaceous intra-alveolar fluid or bilateral central air-space opacity"),
    (r"bronchiectasis.*situs invert|situs invert.*bronchiectasis|kartagener", "bronchiectasis occurring together with mirror-image thoracoabdominal organ orientation (situs inversus), the combination that defines Kartagener/primary ciliary dyskinesia syndrome"),
    (r"bronchiectasis.*cystic fibrosis|cystic fibrosis.*bronchiectasis", "diffuse, bilateral, upper-lobe-predominant bronchiectasis with mucus plugging -- the prototypical pattern the lecture identifies for cystic fibrosis, the most common underlying cause"),
    (r"bronchiectasis.*chronic bronchitis", "bronchiectasis in the setting of chronic airway inflammation from chronic bronchitis rather than a congenital or infectious cause"),
    (r"bronchiectasis.*squamous metaplasia", "squamous metaplasia replacing the normal ciliated respiratory epithelium lining the dilated, chronically inflamed airway"),
    (r"bronchiectasis.*fibrosis and inflammation", "peribronchial fibrosis, chronic inflammatory infiltrate, and loss of cartilage support within the dilated airway wall"),
    (r"bronchiectasis", "permanently dilated, tortuous, easily collapsible bronchi extending toward the visceral pleura with copious secretions and lack of normal tapering (a signet-ring appearance on cross-section)"),
    ...
    (r"emphysema with primary lung cancer|emphysema.*lung cancer", "a discrete mass lesion superimposed on a background of emphysematous change, rather than emphysema alone"),
    (r"pink puffer", "the emphysema-predominant COPD phenotype: dyspneic and tachypneic but with gas exchange reasonably maintained, in contrast to the hypoxemic/hypercapnic 'blue bloater' bronchitic phenotype"),
    (r"emphysema|vanishing lung|\bcopd\b", "hyperinflation, attenuated vascular markings, flattened diaphragms, or large bullous air spaces"),
    ...
    (r"(?<!non-)(?<!non )small cell", "sheets of small hyperchromatic cells with nuclear molding and neuroendocrine marker expression"),
    (r"epithelioid mesothelioma", "the epithelial histologic subtype of mesothelioma: tubulopapillary or sheet-like malignant mesothelial cells, one of the three recognized subtypes (epithelial, sarcomatoid, biphasic)"),
    (r"sarcomatoid.*mesothelioma", "the sarcomatoid (spindle-cell) histologic subtype of mesothelioma, resembling a spindle-cell sarcoma rather than the epithelial or biphasic subtypes"),
    ...
    (r"hematogenous metasta", "multiple discrete, similarly sized round nodules scattered through both lungs, reflecting blood-borne tumor spread rather than a lymphatic-route pattern"),
    (r"lymphan?gitic metasta", "tumor spreading along lymphatic routes -- bronchovascular bundles, interlobular septa, and subpleural regions -- producing a linear/reticular interstitial pattern rather than discrete round nodules"),
    ...
    (r"saddle", "a large thrombus straddling the main pulmonary artery bifurcation, grossly showing alternating pale platelet-fibrin and red-cell bands (lines of Zahn)"),
    (r"wedge shaped pulmonary embol|wedge.shaped.*pulmonary embol", "a segmental filling defect confined to a single wedge-shaped peripheral distribution rather than a central or bilateral pattern"),
    (r"bilateral pulmonary emboli", "multiple filling defects affecting pulmonary arteries in both lungs simultaneously"),
    ...
    (r"plexiform", "a discrete glomeruloid tuft of proliferating endothelial channels within a dilated, often thrombosed pulmonary arteriole -- the advanced Heath-Edwards histologic marker of pulmonary arterial hypertension"),
    (r"pulmonary (arterial )?hypertension", "medial hypertrophy and muscularization of pulmonary arteries with right ventricular hypertrophy/cor pulmonale, without the specific glomeruloid plexiform tuft described as its own finding"),
    ...
    (r"rml silhouette|lingula silhouette", "silhouetting (loss of the sharp border) of the heart, since RML/lingula disease abuts and effaces the cardiac silhouette"),
    (r"lll silhouette|rll silhouette|lower lobe silhouette", "silhouetting (loss of the sharp border) of the hemidiaphragm, since lower-lobe disease abuts and effaces the diaphragmatic margin rather than the heart border"),
    ...
    (r"ankylosing spondylitis", "a seronegative spondyloarthropathy causing fusion (ankylosis) of the spine and sacroiliac joints, producing the characteristic 'bamboo spine' appearance rather than a nonspecific curvature"),
    (r"scoliosis", "lateral (side-to-side) spinal curvature, as from Marfan syndrome, Down syndrome, Ehlers-Danlos syndrome, muscular dystrophy, or idiopathic causes -- a different plane of deformity than kyphosis"),
    (r"kyphosis", "excessive anteroposterior (forward) spinal curvature, from causes such as Scheuermann's disease, osteoporotic compression fracture, or arthritis -- a different plane of deformity than scoliosis"),
...
CONCEPT_SYNONYM_GROUPS: list[set[str]] = [
    ...
    {"centri acinar emphysema", "centriacinar emphysema", "centri acinar emphysema secondary pneumonia"},
    {
        "pectus excavatum",
    ...
    {"hyperinflation in copd", "severe copd", "emphysema"},
    {"neonatal respiratory distress syndrome", "neonatal respiratory distress syndrome hyaline membranes"},
    {"cardiogenic pulmonary edema", "congestive heart failure stage ili alveolar edema"},
    ...
    {"atypical pneumonia", "mycoplasma pneumonia pneumonia"},
    ...
    {"hematogenous metastatic spread", "multiple hematogenous metastases"},
    {"peripheral tumor", "primary lung cancer", "non small cell lung cancer"},
    {
    ...
    {"lung mass", "left hilar lung mass", "lung nodule"},
    {"silicosis", "circumscribed silicotic nodule from silicosis"},
    {"left hilar lung mass", "lung mass", "lung nodule", "non small cell lung cancer", "peripheral tumor", "primary lung cancer"},
    {"bilateral upper lobe cavitary lung disease tb", "cavitary tb", "old right upper lobe rul and pleural tb", "secondary tb", "tb"},
    {"endobronchial tumor golden s sign", "golden s sign from obstructing squamous cell carcinoma", "post obstructive resorptive atelectasis golden s", "resorption atelectasis collapse"},
    {"near normal lung filling pattern", "normal infant", "normal lung large", "normal lungs"},
    {"chronic interstitial lung disease", "fibrotic interstitial lung disease", "interstitial fibrosis", "interstitial lung disease"},
    {"ards", "acute respiratory distress syndrome", "diffuse alveolar damage ards", "trauma induced diffuse alveolar damage"},
    {"congenital diaphragmatic hernia", "congenital diaphragmatic hernia with scaphoid abdomen", "diaphragmatic hernia", "left sided congenital diaphragmatic hernia"},
    {"cryptococcus neoformans india ink stain", "cryptococcus neoformans", "encapsulated cryptococcus neoformans"},
    {"invasive aspergillosis", "invasive aspergillus", "invasive fungal sinusitis"},
    {"lateral pectus carinatum", "lower pectus carinatum", "pectus arcuatum"},
    {"lobar pneumonia", "lobar pneumonia acute alveolar inflammation", "right upper lobe lobar consolidation pneumonia"},
    {"normal airway", "normal bronchus"},
    {"non necrotizing granuloma in sarcoidosis", "pulmonary sarcoidosis", "sarcoidosis"},
    {"chronic silicosis progressive massive fibrosis", "circumscribed silicotic nodule from silicosis", "silicosis"},
    {"bacterial pneumonia", "community acquired pneumonia", "lung consolidation pneumonia"},
    {"acinus", "normal acinus"},
    ...
    {"acute asthma attack", "asthma"},
    {"blastomyces dermatitidis yeast form", "blastomycosis"},
    {"radiation damage from breast cancer treatment", "radiation damage from lung cancer treatment"},
    {"viral nuclear inclusions", "viral pneumonia"},
    {"bronchi", "bronchus"},
    {"central tumor", "endobronchial tumor"},
    {"acute inflammation in lobar pneumonia", "congestion phase of pneumonia"},
    {"malignant pleural mesothelioma", "mesothelioma", "mesothelioma encasing lung", "pleural mesothelioma"},
    {"coccidioides spherules", "coccidioidomycosis"},
    {"trachea", "trachea large"},
    {"consolidative tb with hilar lymphadenopathy", "lymphadenopathy"},
    {"pulmonary hypertension", "pulmonary arterial hypertension"},
    {"plexiform lesion", "plexiform lesions of pulmonary arterial hypertension"},
    {"chronic rhinosinusitis with nasal polyps", "nasal polyps from egpa churg strauss", "severe polyposis"},
    ...
    {"empyema", "empyema eith air from gas producing organisms"},
    {
        "asbestos body",
        "asbestos bodies",
        "ferruginous bodies",
        "asbestos ferruginous body prussian blue stain",
    },
    {"croup", "croup steeple sign"},
    {
        "endobronchial tumor",
        "endobronchial tumor golden s sign",
        "golden s sign from obstructing squamous cell carcinoma",
        "post obstructive resorptive atelectasis golden s",
    },
    {
        "recurrent respiratory papillomatosis",
        "pulmonary involvement by recurrent respiratory papillomatosis",
    },
    {"vocal cord nodules", "vocal fold vf lesions"},
    {
        "noncaseating granuloma",
        "noncaseating granulomas",
        "multinucleated giant cells in a noncaseating granuloma",
        "non necrotizing granuloma in sarcoidosis",
    },
    {"lines of zahn", "lines of zahn in thrombus"},
    {"old organized thromboembolism", "organized venous thromboembolus"},
    {"encapsulated streptococcus pneumoniae", "streptococcus pneumoniae pneumococci"},
    {"invasive aspergillosis", "invasive aspergillus"},
    {"aspergilloma", "fungal ball", "colonized cavity of aspergilloma"},
    {"right pulmonary agenesis", "right lung agenesis with left compensatory hyperinflation"},
    {"kartagener syndrome", "bronchiectasis and situs invertis", "situs invertis"},
    {"bronchiectasis", "bronchiectasis lung specimens", "bronchiectasis right lung saggital"},
    {"cavitary tb", "cavitary pulmonary tuberculosis", "tb"},
]

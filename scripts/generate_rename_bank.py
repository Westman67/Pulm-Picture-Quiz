...
FEATURE_RULES: list[tuple[str, str]] = [
    ...
    (r"pulmonary hypertension", "medial hypertrophy and muscularization of pulmonary arteries with right ventricular hypertrophy/cor pulmonale, without the specific glomeruloid plexiform tuft described as its own finding"),
